...
export async function GET(req) {
  ...
  try {
    ...
    return NextResponse.json(handleError(err, 'Falha ao buscar regras de cobrança'), { status: 500 });
  }
}
...
export async function POST(req) {
  ...
  try {
    ...
    return NextResponse.json(handleError(err, 'Falha ao criar regra de cobrança'), { status: 500 });
  }
}
